...
MOVE_WINRATE_LOSS_WEIGHT: float = 0 / 0.5  # Sigmoid win% prediction (legal moves only)
ILLEGALITY_LOSS_WEIGHT: float = 0  # Hinge loss to push illegal logits down (~10x less than policy)
